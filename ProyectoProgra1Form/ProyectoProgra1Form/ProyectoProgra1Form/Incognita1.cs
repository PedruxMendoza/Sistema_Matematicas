...
{
    public partial class Incognita1 : Form
    {
        //Declaracion de Variables
        public double a, b, c, resul;
        ...
        {//Primero vereficamos si tenemos informacin en la variables de resultado
            ...
            {
                //Declaramos que incognita fue la que ingresoo el usuario
                string inc = txtIncognita.Text;
                ...
                {//Verificamos que el archivo no tenga espacio en blanco
                    ...
                    {//Si no es asi y tenemos un nombre al archivo creamos ese archivo con el nombre que nosotros le asignamos y comenzamos a escribir
                        ...
                        if (a != 0)
                        {//Verificamos que el valor de a sera diferente de cero
                            if (b >= 0)
                            {//Tambien vemos si el valor de b es positivo
                                escribir.WriteLine("\nEcuacion a resolver: " + a + inc + " +" + b + " = " + c);
                            }
                            else
                            {//O si es negativo
                                escribir.WriteLine("\nEcuacion a resolver: " + a + inc + " " + b + " = " + c);
                            }//De ahi escribimos el resultado que nos dio al resolver la ecuacion
                            escribir.WriteLine("\n====================================================================");
                            escribir.WriteLine("\nEl valor encontrado es");
                            escribir.WriteLine("X = " + resul);
                        }
                        else
                        {//Si el valor de a es cero escribimos en el documento que es imposible
                            escribir.WriteLine("\n====================================================================");
                            escribir.WriteLine("\nEl valor encontrado es");
        ...
        private void txtIncognita_KeyPress(object sender, KeyPressEventArgs e)
        {
            //Llamamos el metodo que nos sirve para ingresar solo letras
            val.soloLetras(e);
        }
        ...
        {//Primero verificamos si no se ha dejado vacio los textbox 
            ...
            else
            {
                ...
                if (a != 0)
                {
                    if (txtIncognita.TextLength >= 2)
                    {
                        MessageBox.Show("Introducir solo una variable", "Aviso!!!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
                        resul = (c - b) / a;
                        lblIncognita.Text = txtIncognita.Text;
                        lblResultado.Text = resul.ToString();
                    }
                }
                else
                {
                    MessageBox.Show("Valor Indeterminado", "Aviso!!!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    lblIncognita.Text = txtIncognita.Text;
                    lblResultado.Text = "Imposible";
                }
            }
        }
    }
